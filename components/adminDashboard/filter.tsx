      ...
      <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-3 bg-[#0a0a0a] border border-gray-700/50 rounded-xl text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-transparent transition-all h-[52px]"
          />
          {searchTerm && (
            <button
        ...
        <div className="flex items-center gap-3 w-full lg:w-auto">
          <div className="flex-1 lg:w-[200px]">
            <Select value={sortOrder} onValueChange={setSortOrder}>
              <SelectTrigger className="w-full h-[52px] min-h-[52px] max-h-[52px] bg-[#0a0a0a] border border-gray-700/50 text-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500/50 cursor-pointer hover:border-gray-600 transition-all">
          ...
          <div className="flex bg-[#0a0a0a] border border-gray-700/50 rounded-xl p-1">
            <button
              ...
              className={`p-2.5 rounded-lg transition-all cursor-pointer ${
                viewMode === "grid"
                  ? "bg-teal-600/20 text-teal-400 ring-1 ring-teal-200/30"
          ...
          <Button
            ...
            className="bg-teal-900 hover:bg-teal-700   flex items-center gap-2 whitespace-nowrap h-[52px] cursor-pointer font-semibold px-6 rounded-xl transition-all  shadow-lg  cursor-pointer"
          >
