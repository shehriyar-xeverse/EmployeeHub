...
import NotificationsCards from '@/components/notifications/notfiycards';
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0a] via-[#0d0d0d] to-[#0a0a0a] font-quicksand">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
          <div>
            <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent flex items-center gap-3">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-sm transition-all duration-300 cursor-pointer ${
                  filter === 'all'
                    ...
                    : 'bg-[#0a0a0a] text-gray-400 hover:text-white border border-gray-700/50 hover:border-purple-500/30'
                }`}
              >
                All ({counts.all})
              </button>
